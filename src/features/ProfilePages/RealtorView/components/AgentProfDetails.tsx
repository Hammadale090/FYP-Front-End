      ...
      <div className="bg-[#FCFCFC] flex flex-col space-y-2 rounded-[10px] w-full md:w-[70%] max-md:my-2 p-[20px]">
        ...
        <div className="flex flex-wrap max-md:justify-center">
          <AgentStatus
            ...
            data={[{ name: "Listings", color: "#ff5353", value: 800 }]}
            amount="1050"
          />
          <AgentStatus
            header="Properties Sold"
            data={[{ name: "Properties sold", color: "#32ea94", value: 800 }]}
            amount="1050"
          />
        </div>
      </div>
