...
const AgentStatus = ({ header, data, amount }: Props) => {
    return (
        <div className={`px-[31px] w-full sm:mr-2 md:mr-5 my-2 sm:max-md:max-w-[301px] md:w-[301px] flex justify-between border border-[#E4E4E4] shadow-md items-center py-[59px] gap-[10px] rounded-[10px] bg-[#FCFCFC] `}>
