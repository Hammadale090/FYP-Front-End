...
import AgentSold from "./components/AgentSold";
...
const RealtorView = (props: Props) => {
  ...
  return (
    <div>
      {/* the header */}
      <h1 className="text-[#11142D] text-[25px] font-bold">Realtor Page</h1>
      ...
      {/* the active Listing */}
      <AgentActiveListing slug={profileId} />
