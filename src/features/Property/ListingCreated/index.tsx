            ...
            <div className="flex space-x-4 text-[24px]">
              ...
              <div className="flex items-center  ">
                ...
                {propertyData?.attributes?.favourites
                  ? propertyData?.attributes?.favourites[0]
                  : 0}
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row w-full pt-4">
          ...
          <div className=" flex flex-col  w-full md:w-2/3  ">
                ...
                <Image
                  src={
                    propertyData?.attributes?.coverPhoto?.data?.attributes
                      ?.url || propertyData?.attributes?.coverPhotoFromUrl
                  }
                  alt="property cover image"
                  width={800}
                  height={800}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4 mt-1">
                {(propertyData?.attributes?.Gallery?.data?.length > 0
                  ...
                  <Image
                    ...
                    onClick={() => {
                      setChosenImage(galleryImg?.attributes?.url || galleryImg);
                      openPreview();
                    }}
                    alt="property cover image"
                    width={400}
            ...
            <div className="grid grid-cols-2 items-center md:grid-cols-4  ">
              {[
                ...
                return (
                  <div
                    className="flex flex-col-2 items-center gap-2 mx-6  my-3"
                    key={index}
                  >
                    <div className="bg-[#F3F3F3] w-[50px] h-[50px] rounded-[8px] flex items-center justify-center">
                      <Image
                        src={i.image}
                        alt="property cover image"
                        width={100}
                        height={100}
                        className="w-[28px] h-[28px] contain  rounded-md"
                      />
                    </div>
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-[#0B0C0E] text-[14px] font-semibold">{i?.value}</p>
                    </div>
                  </div>
                );
              })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:space-y-6 ">
              {[
                ...
                },
                {
                  name: "Equipement:",
                  value:
                    propertyData?.attributes?.additional_information?.equipment,
                },
                {
                  name: "Pool size:",
                  value:
                    propertyData?.attributes?.additional_information?.poolSize,
                },
                {
                  name: "Amenities:",
                  value:
                    propertyData?.attributes?.additional_information?.amenties,
                },
                {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:space-y-6 ">
              {[
                ...
                { name: "Country:", value: propertyData?.attributes?.country },
              ].map((i, index) => {
                return (
                  <div
                    className="flex flex-row border-b-[1px]  justify-between items-center border-b-[#F3F3F3] space-y-2 mr-6  mt-4"
            ...
            {/* the review */}
            <Review slug={propertyData?.attributes?.professional_profile?.data
              ?.attributes?.client_profile?.data?.attributes?.user?.data?.id} />
                  ...
                  <div className="w-full flex">
                    <div className="w-[40%] flex flex-col items-center">
                      ...
                      <h2 className="text-center font-semibold text-[64px] text-[#34495D]">
                        {/* 28º */}
                        {(currentWeather?.main?.temp - 273.5).toFixed(2) +
                      ...
                      <div className="flex items-center">
                        <p className="text-center font-normal text-[18px] text-[#34495D] mr-[14px]">
                          Max.:{" "}
                          {(currentWeather?.main?.temp_max - 273.5).toFixed(2) +
                            String.fromCharCode(176)}
                        </p>
                        <p className="text-center font-normal text-[18px] text-[#34495D]">
                          Min.:{" "}
                    ...
                    <div className="w-[45%]">
                      <div className="w-full flex items-center justify-between">
                        ...
                        <span className="flex items-center">
                          <Image
                            ...
                            height={30}
                          />
                          {(currentWeather?.wind?.speed * 3.6)?.toFixed(0)} km/h
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-[12px]">
                        {hourlyWeather?.map((hourWeather: any, ind: any) => {
                          const temp =
                            (hourWeather?.main?.temp - 273.5).toFixed(2) +
                            String.fromCharCode(176);
              ...
              <div className="relative w-full max-h-[437px]">
                <iframe
                  ...
                  src={
                    ...
                    // ??
                    "https://my.matterport.com/show/?play=1&lang=en-US&m=6hzzgsjzLsW"
                  }
                  title="YouTube video player"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          ...
          <div className="bg-[#F3F3F3] rounded-[8px] w-full max-w-[370px] h-fit p-6 mt-6 md:mt-0 md:ml-4 flex flex-col items-center">
            <div className="flex flex-col items-center">
              <Image
                src={
                  propertyData?.attributes?.coverPhoto?.data?.attributes?.url
                }
                alt="property cover image"
                width={400}
                height={400}
              ...
              />
              <p className="text-[#292640] cursor-pointer text-[16px] font-[600] leading-[18px] tracking-[0.5px]  mt-4">
                {
              ...
              <p className="mt-1 text-[16px] font-[400] ">
                {
                  propertyData?.attributes?.professional_profile?.data
                    ?.attributes?.client_profile?.data?.attributes
                    ?.role
                }
              </p>
              <p className="mt-1 text-[16px] font-[400] ">
              ...
              <Rating slug={propertyData?.attributes?.professional_profile?.data
                ?.attributes?.client_profile?.data?.attributes?.user?.data?.id} />
              {/* here now */}
