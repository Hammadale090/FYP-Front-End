...
const BrokerCard = ({ realtor, firstname, lastname, phone, email, url, profile_pic, Agency_name }: Props) => {
    return (
        <div className='w-full md:w-[370px] h-full md:h-[449px] cursor-pointer md:mx-2 my-2 flex-shrink-0  rounded-xl'>
            ...
            <Image height={1000} width={1000} className='h-[240px] rounded-t-xl object-cover' alt='property Image' src={profile_pic ?? "/Dashboard/Realtors.svg"} />
            {/* The lower div */}
