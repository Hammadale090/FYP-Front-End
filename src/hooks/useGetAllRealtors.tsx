...
export function useGetAllRealtors() {
  ...
  async function getRealtors(page = pagination.page) {
    setLoading(true);
    const personal = await fetcher(
      `${
        process.env.NEXT_PUBLIC_STRAPI_URL
      }/client-profiles?filters[role][$eq]=${"realtor"}&populate[0]=profile_pic&populate[1]=professional_profile.professional_photo&populate[2]=agency&populate[3]=user&pagination[page]=${page}&pagination[pageSize]=25&sort=createdAt:DESC`,
      {
        headers: {
